...
use Modules\TomatoUserActivities\App\Console\TomatoUserActivitiesInstall;
use TomatoPHP\TomatoAdmin\Facade\TomatoMenu;
use TomatoPHP\TomatoAdmin\Services\Contracts\Menu;

class TomatoUserActivitiesServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'TomatoUserActivities';

    protected string $moduleNameLower = 'tomato-user-activities';
    ...
    public function boot(): void
    {
        ...
        $this->commands([
            TomatoUserActivitiesInstall::class
        ]);
